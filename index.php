...
<form action="product.php" method="post"><button type="submit" class="zamov">Замовити</button></form>
</div>
<div class="why">
    ...
    <ul class="log">
        <li>
            <div>
                <img src="photo/guarantee-svgrepo-com (1).svg">
                <p>Головна</p>
        ...
        <li>
            <div>
                <img src="photo/sausage-svgrepo-com.svg">
                <p>Вибір</p>
        ...
        <li>
            <div>
                <img src="photo/delivery-transport-svgrepo-com.svg">
                <p>Доставка</p>
...
<div class="product">
    <p>Продукція</p>
    <ul class="prod">
        <a href="syrokopcheni.php"><li>
                <div >
                    <img src="photo/index-product/syrokopchena_kovbaca.jpg">
                    <div>
                        <p>Сирокопчені ковбаси</p>
                        <div>
                            <img src="photo/right.svg">
                        </div>
                    </div>
                </div>
            </li></a>
        <a href="syrokopcheni.php"><li>
                <div >
                    <img src="photo/index-product/shynka.jpg">
                    <div>
                        <p>Шинки</p>
                        <div>
                            <img src="photo/right.svg">
        ...
        <a href="syrokopcheni.php"><li>
                <div >
                    <img src="photo/index-product/varena_kovbaca.jpg">
                    <div>
                        <p>Варені ковбаси</p>
                        <div>
                            <img src="photo/right.svg">
        ...
        <a href="syrokopcheni.php"><li>
                <div >
                    <img src="photo/index-product/sosyska.jpg">
                    <div>
        ...
        <a href="syrokopcheni.php"><li>
                <div >
                    <img src="photo/index-product/syrokopcheni_prodyktu.jpg">
                    <div>
